# PluginInstalled
PluginInstalled analyse ton système et te donne en un mot le nombre exact de plugins installés.
...
# Multi-language
The PluginInstalled plugin relies solely on the system's available languages.
